...
- Manipulates commit history
  - change commit's messages
  - delete/reorder commits
  - combine multiple commits into one
  - edit/split an existing commit into multiple ones

- Do NOT use Interactive Rebease on commits that are pushed/shared on a remote repo!
- Use it for cleaning up your local commit
